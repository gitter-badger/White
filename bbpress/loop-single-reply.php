...
<bottom data-toggle="tooltip" data-placement="bottom" title="Add to favorites" class="btn btn-sm btn-danger"><?php bbp_user_favorites_link(); ?></bottom>
<?php endif; ?>
<?php if ( bbp_is_topic(bbp_get_reply_id()) ) : ?>
<bottom data-toggle="tooltip" data-placement="bottom" title="Reply to topic" class="btn btn-sm btn-primary"><?php echo bbp_get_topic_reply_link(); ?></bottom>
<?php endif; ?>
<?php if ( bbp_is_reply(bbp_get_reply_id()) ) : ?>
<bottom data-toggle="tooltip" data-placement="bottom" title="Reply to comment" class="btn btn-sm btn-danger"><?php echo bbp_get_reply_to_link(); ?></bottom>
<?php endif; ?>
</div>
<?php endif; ?>
<div class="ime">
