	...
	<div id="bbp-single-user-details">
			...
			<ul class="nav-pills nav-stacked">
				...
				<li class="<?php if ( bbp_is_single_user_replies() ) :?>active<?php endif; ?>">
						<a href="<?php bbp_user_replies_created_url(); ?>" title="<?php printf( esc_attr__( "%s's Replies Created", 'bbpress' ), bbp_get_displayed_user_field( 'display_name' ) ); ?>"><i class="fa fa-comment-o"></i> <?php _e( 'Moji odgovori', 'bbpress' ); ?></a>
				</li>

				<?php if ( bbp_is_favorites_active() ) : ?>
					<li class="<?php if ( bbp_is_favorites() ) :?>active<?php endif; ?>">
							<a href="<?php bbp_favorites_permalink(); ?>" title="<?php printf( esc_attr__( "%s's Favorites", 'bbpress' ), bbp_get_displayed_user_field( 'display_name' ) ); ?>"><i class="fa fa-star"></i> <?php _e( 'Omiljene teme', 'bbpress' ); ?></a>
					</li>
				<?php endif; ?>
