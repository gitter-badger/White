...
function white_menu() {
	add_menu_page('White Opcije', 'White Opcije', 'administrator', 'white', 'white_stranica');
...
<div class="col-md-6">
    <label>Boje</label>
    <p>Ovde unesite boju za forum koji ste uneli levo.</p>
    <select id="white_boja_1" name="white_boja_1" class="form-group form-control input-sm">
    <option value="<?php echo esc_attr( get_option('white_boja_1')); ?>">Odabrana boja je: <?php echo ucfirst(esc_attr( get_option('white_boja_1')) ); ?></option>
   ...
   <option value="<?php echo esc_attr( get_option('white_boja_2')); ?>">Odabrana boja je: <?php echo ucfirst(esc_attr( get_option('white_boja_2')) ); ?></option>
    <option value="siva">Siva</option>
    <option value="zelena">Zelena</option>
    <option value="plava">Plava</option>
    <option value="crvena">Crvena</option>
    ...
    <option value="<?php echo esc_attr( get_option('white_boja_3')); ?>">Odabrana boja je: <?php echo ucfirst(esc_attr( get_option('white_boja_3')) ); ?></option>
    <option value="siva">Siva</option>
    <option value="zelena">Zelena</option>
    <option value="plava">Plava</option>
    <option value="crvena">Crvena</option>
    ...
    <option value="<?php echo esc_attr( get_option('white_boja_4')); ?>">Odabrana boja je: <?php echo ucfirst(esc_attr( get_option('white_boja_4')) ); ?></option>
    <option value="siva">Siva</option>
    <option value="zelena">Zelena</option>
    <option value="plava">Plava</option>
    <option value="crvena">Crvena</option>
    ...
    <option value="<?php echo esc_attr( get_option('white_boja_5')); ?>">Odabrana boja je: <?php echo ucfirst(esc_attr( get_option('white_boja_5')) ); ?></option>
    <option value="siva">Siva</option>
    <option value="zelena">Zelena</option>
    <option value="plava">Plava</option>
    <option value="crvena">Crvena</option>
